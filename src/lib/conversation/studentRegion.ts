...
const INVALID_REGION_NAMES =
  /(?:第一期|第二期|第三期|营期|线上|线下|学生班|课程|学校|家长|学生|教师|老师|机构|企业|所在地区|其他城市|其他地区|非北上广|出行|不便|不能|无法|方便|前往|可以|均不|都不)/u;

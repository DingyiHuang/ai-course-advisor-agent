...
const INVALID_REGION_NAMES =
  /(?:我是|作为|第一期|第二期|第三期|营期|暑假|寒假|集中学习|全天学习|线上|线下|学生班|课程|学校|家长|学生|教师|老师|机构|企业|所在地区|其他城市|其他地区|非北上广|什么时候|什么|多少|哪里|哪儿|哪几|何处|怎么|如何|地点|地址|费用|价格|上课|回放|退款|设备|准备|出行|不便|不能|无法|方便|前往|可以|均不|都不)/u;
